...
@section('content')
<div class="container">
    <h2 class="title" style="font-family:serif; text-align:center; margin-top:20px; border-bottom:solid 2px #CC99CC">{{ $user->name }}の投稿一覧____合計{{ $user->contents_count }}件</h2>
        <div class="row">
